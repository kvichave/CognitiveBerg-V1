...
const Page = () => {
  ...
  useEffect(() => {
    if (isLoaded && user) {
      ...
      const response = fetch("http://localhost:5000/api/store_session", {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      ...
      <div class="stats-section py-10 px-5">
        <div class="stats-grid z-20 max-w-5xl rounded-xl bg-[#FF6347] dark:bg-[#4B5563] mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 items-center justify-between md:px-10 gap-x-10 py-10 px-5 lg:px-10 gap-y-5">
          <div class="col-span-1 md:col-span-3 lg:col-span-1 flex flex-col items-center justify-center gap-y-3">
            <h2 class="text-3xl md:pb-5 md:text-3xl text-white dark:text-gray-200 font-bold">
              Here are your scores
            </h2>
          </div>
          <div class="col-span-1 md:col-span-1 lg:col-span-1 flex flex-col items-center justify-center gap-y-3">
            <h2 class="text-3xl lg:text-5xl text-white dark:text-gray-200 font-bold">
              1.2M
            </h2>
            <p class="text-center text-sm md:text-base text-white dark:text-gray-400">
              Members worldwide
            </p>
          </div>
          <div class="col-span-1 md:col-span-1 lg:col-span-1 flex flex-col items-center justify-center gap-y-3">
