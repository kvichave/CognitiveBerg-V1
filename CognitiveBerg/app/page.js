  ...
  return (
    <>
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
        <div className="text-4xl z-30 mb-auto ml-auto fixed right-2 top-2">
          <UserButton
            showName
            userProfileProps={{
              className: "text-2xl font-semibold text-blue-400", // Customize name styles here
            }}
          ></UserButton>
        </div>
        <div className="mb-auto">
          <h2 className="bg-clip-text  text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight mt-72">
            <br /> Cognitive Berg.
          </h2>
      ...
      <SignedOut>
        <LampContainer>
          <motion.h1
            ...
            className="mt-8 -mb-[24rem] bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
          >
            Let's Begin <br /> Signup
          </motion.h1>
        </LampContainer>
        <div className="flex pb-20  items-center justify-center h-40 bg-gradient-to-b from-black to-[#111827]">
          <div className="flex space-x-4">
            <button
              onClick={() => router.push("/auth/sign-up")}
              className="px-6 py-4 text-sm text-white bg-blue-600 rounded-lg border border-white/20"
            >
              Login
            </button>
            <button
              onClick={() => router.push("/auth/sign-in")}
              className="px-4 py-2 text-sm text-blue-600 bg-white rounded-lg border border-blue-600/20"
            >
              Register
            </button>
          </div>
      ...
      <SignedIn>
        <section className="h-auto bg-black w-full pt-12 md:pb-20 border-b border-[#23232C] p-3 ">
          <div className="max-w-6xl mx-auto md:text-center tails-relative">
            <h2 className="jakarta text-white font-bold text-xl md:px-0 px-10 md:text-3xl">
              AI powered Virtual Environment ✨
            </h2>
            <p className="text-gray-400 mt-2 md:mt-5 md:px-0 px-10 md:text-2xl">
              Try out the app for yourself to see the magic!
            </p>
            <a
              href="/dashboard"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
            <a href="/" className="flex justify-center ">
              <div className="text-2xl font-bold">𝗖𝗼𝗴𝗻𝗶𝘁𝗶𝘃𝗲 𝗕𝗲𝗿𝗴</div>
            </a>
          ...
          <div className="py-7 border-t border-gray-700">
            <div className="flex items-center justify-center">
              <span className="text-gray-400 ">
                ©<a href="https://pagedone.io/">Cognitive Berg</a>2025, All
                rights reserved.
              </span>
            </div>
          </div>
